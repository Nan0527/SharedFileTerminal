...
//	QByteArray pstr=m_primaryMessage.left(99).toAscii();
    QByteArray pstr=m_primaryMessage.left(99).toUtf8();
...
//	QByteArray fstr=filename.left(255).toAscii();
    QByteArray pstr=m_primaryMessage.left(99).toUtf8();
    QByteArray fstr=filename.left(255).toUtf8();
...
//	QByteArray bgcol=bg_colour_hash.right(6).toAscii();
    QByteArray fgcol=fg_colour_hash.right(6).toUtf8();
    QByteArray bgcol=bg_colour_hash.right(6).toUtf8();
